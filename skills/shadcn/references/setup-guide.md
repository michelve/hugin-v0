...
### Option 2: Classic Manual Setup (Vite + React)
...
6. **React Server Components**: Choose based on your framework
   - `no` for Vite (this project uses Vite)
...
- App Router: set `rsc: true`, add `"use client"` to stateful components
- Pages Router: set `rsc: false`
